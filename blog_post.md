...
1. STEP 1:
For the first caption, the model takes the output from the *first timestep of the image encoder* and passes that as the first hidden state for the decoder. The *decoder* uses *image encoding* and the *initial caption* to generate the very first caption. 
